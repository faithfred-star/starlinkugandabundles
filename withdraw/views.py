...
def landing_page(request):
    ...
    if not packages.exists():
        StarlinkPackage.objects.create(name="Basic", description="Great for light browsing and social media.", price=1750.00, data_limit="30GB")
        StarlinkPackage.objects.create(name="Standard", description="Ideal for streaming and everyday use.", price=3500.00, data_limit="60GB")
        StarlinkPackage.objects.create(name="Premium", description="Perfect for families and heavy users.", price=6000.00, data_limit="120GB")
        StarlinkPackage.objects.create(name="Ultra", description="High-speed data for power users.", price=10000.00, data_limit="250GB")
        StarlinkPackage.objects.create(name="Business", description="Reliable connectivity for businesses.", price=18000.00, data_limit="500GB")
        StarlinkPackage.objects.create(name="Unlimited", description="Unlimited high-speed satellite internet. Best value!", price=30000.00, data_limit="Unlimited")
        packages = StarlinkPackage.objects.filter(is_active=True)
